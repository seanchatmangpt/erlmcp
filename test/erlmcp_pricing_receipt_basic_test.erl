...
create_starter_plan_receipt_test() ->
...
add_refusal_queue_overflow_test() ->
    % Create receipt
    {ok, Receipt} = erlmcp_pricing_receipt:create_receipt(free, <<"1.0">>),
...
conformance_fail_throughput_test() ->
    % Create receipt
    {ok, Receipt} = erlmcp_pricing_receipt:create_receipt(free, <<"1.0">>),
    ReceiptId = maps:get(receipt_id, Receipt),
...
tamper_detection_envelope_test() ->
    % Create receipt
    {ok, Receipt} = erlmcp_pricing_receipt:create_receipt(free, <<"1.0">>),
...
tamper_detection_timestamp_test() ->
    % Create receipt
    {ok, Receipt} = erlmcp_pricing_receipt:create_receipt(free, <<"1.0">>),
