...
-spec inject(atom(), map()) -> {ok, term()} | {error, term()}.
inject(Type, Config) ->
    inject(Type, Config, #{duration => 5000}).

-spec inject(atom(), map(), map()) -> {ok, term()} | {error, term()}.
...
-spec schedule_chaos(list()) -> {ok, term()} | {error, term()}.
schedule_chaos(Schedule) ->
    schedule_chaos(Schedule, #{}).

-spec schedule_chaos(list(), map()) -> {ok, term()} | {error, term()}.
schedule_chaos(Schedule, Options) ->
    gen_server:call(?MODULE, {schedule_chaos, Schedule, Options}).

%% @doc Run a complete chaos experiment
-spec run_experiment(map()) -> {ok, term()} | {error, term()}.
run_experiment(ExperimentConfig) ->
    run_experiment(ExperimentConfig, #{}).

-spec run_experiment(map(), map()) -> {ok, term()} | {error, term()}.
...
-spec network_delay(map()) -> {ok, term()} | {error, term()}.
...
-spec message_drop(map()) -> {ok, term()} | {error, term()}.
message_drop(Config) ->
    #{
        drop_rate := DropRate,
...
-spec connection_failure(map()) -> {ok, term()} | {error, term()}.
...
-spec process_crash(map()) -> {ok, term()} | {error, term()}.
...
-spec memory_pressure(map()) -> {ok, term()} | {error, term()}.
