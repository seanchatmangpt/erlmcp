...
test_metric_types() ->
    ?_test(begin
               ...
               ?assertMatch({match, _},
                            re:run(MetricsText, <<"# TYPE erlmcp_requests_total counter">>)),
               ?assertMatch({match, _},
                            re:run(MetricsText,
               ...
               % Verify gauge types
               ?assertMatch({match, _},
                            re:run(MetricsText, <<"# TYPE erlmcp_connections_active gauge">>)),
               ?assertMatch({match, _},
                            re:run(MetricsText, <<"# TYPE erlmcp_memory_total_bytes gauge">>))
           end).
