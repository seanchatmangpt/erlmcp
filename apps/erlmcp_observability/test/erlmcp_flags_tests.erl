...
test_flag_transitions() ->
    ?_test(begin
        ...
        States = [
            ...
            {fun erlmcp_flags:enter_maintenance_mode/0, fun erlmcp_flags:is_maintenance_mode/0, true},
            {fun erlmcp_flags:exit_maintenance_mode/0, fun erlmcp_flags:is_maintenance_mode/0, false},
            {fun erlmcp_flags:start_shutdown/0, fun erlmcp_flags:is_shutting_down/0, true},
            {fun erlmcp_flags:cancel_shutdown/0, fun erlmcp_flags:is_shutting_down/0, false},
