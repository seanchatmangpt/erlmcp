...
cleanup_validator(TestDir) ->
    ...
    case file:list_dir(TestDir) of
        {ok, Files} ->
            lists:foreach(fun(F) -> file:delete(TestDir ++ "/" ++ F) end, Files);
        _ ->
            ok
    end,
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Latencies = #{<<"latency_p50_us">> => 80.0, <<"latency_p95_us">> => 400.0},
                    % p99 missing
                    Thresholds = #{},
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Result =
                        erlmcp_performance_validator:validate_throughput(Throughput, MinThroughput),
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Result =
                        erlmcp_performance_validator:validate_throughput(Throughput, undefined),
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Throughput = #{<<"some_other_field">> => 123},
                    MinThroughput = 100000,
...
validate_memory_default_limit_test_() ->
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    % Given: Memory map
                    Memory = #{<<"memory_per_connection_mib">> => 8.0},
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Result =
                        erlmcp_performance_validator:validate_concurrency(Concurrency,
                                                                          MaxConnections),
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Result =
                        erlmcp_performance_validator:benchmark_comparison(Current,
                                                                          Baseline,
                                                                          TolerancePercent),
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Baseline =
                        #{<<"throughput_msg_per_s">> => 1000000.0, <<"latency_p99_us">> => 1000.0},
                    Current =
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    BenchmarkFile =
                        "/Users/sac/erlmcp/bench/results/core_ops_core_ops_100k_1769824174.json",
                        ...
                        #{latency =>
                          ...
                          memory =>
                              #{<<"memory_per_connection_mib">> =>
                                    maps:get(<<"memory_delta_mib">>, Benchmark)
                                    / 100000},  % Approximate
                          concurrency => #{<<"concurrent_connections">> => 100}},
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    BaselineFile =
                        "/Users/sac/erlmcp/bench/results/core_ops_core_ops_100k_1769824174.json",
                    CurrentFile =
                        "/Users/sac/erlmcp/bench/results/core_ops_core_ops_100k_1769835665.json",
                    ...
                    Result =
                        erlmcp_performance_validator:benchmark_comparison(Current, Baseline, 10),
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Throughput = #{<<"throughput_msg_per_s">> => 0.0},
    ...
    {setup,
     ...
     fun(_TestDir) ->
        [?_test(begin
                    ...
                    Result1 =
                        erlmcp_performance_validator:benchmark_comparison(Current1, Baseline, 10),
                    ?assertMatch({pass, _}, Result1),

                    % 10.1% degradation should fail
                    Current2 = #{<<"throughput_msg_per_s">> => 899000.0},
                    Result2 =
                        erlmcp_performance_validator:benchmark_comparison(Current2, Baseline, 10),
