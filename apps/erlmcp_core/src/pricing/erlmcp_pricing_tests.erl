     ...
     fun(_) ->
         [
          ?_test(begin
                     ...
                     ?assertEqual({error, invalid_tier_upgrade},
                                  erlmcp_pricing:upgrade(UserId, 1)),
     ...
     fun(_) ->
         [
          ?_test(begin
                     ...
                     ?assertEqual({error, already_on_tier},
                                  erlmcp_pricing:upgrade(UserId, 1))
                 end)
         ]
     end}.
     ...
     fun(_) ->
         [
          ?_test(begin
                     ...
                     ?assertEqual({error, invalid_tier_upgrade},
                                  erlmcp_pricing:upgrade(UserId, 99))
                 end)
         ]
     end}.
     ...
     fun(_) ->
         [
          ?_test(begin
                     ...
                     ?assertEqual(ok,
                                  erlmcp_pricing_cli:upgrade(UserId, pro)),
     ...
     fun(_) ->
         [
          ?_test(begin
                     ...
                     Result = erlmcp_pricing_http:handle_request(
                                <<"POST">>,
                                <<"/api/pricing/upgrade">>),
