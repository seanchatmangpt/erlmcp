...
-export([
    format_price/1,
    calculate_prorated_cost/3,
    days_in_month/2,
    validate_plan_name/1,
    merge_usage/2
]).
...
-spec calculate_prorated_cost(MonthlyCost :: integer(), DaysUsed :: integer(), DaysInMonth :: integer()) -> integer().
