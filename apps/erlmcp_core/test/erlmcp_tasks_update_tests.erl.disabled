...
test_update_task_progress() ->
    ...
    ok = erlmcp_tasks:update_progress(undefined, TaskId, #{
...
concurrent_update_test_() ->
    {setup,
     ...
     fun(_Pid) ->
         [
          ?_test(test_concurrent_updates_serialize()),
          ?_test(test_update_race_condition())
         ]
     end}.
...
test_update_progress_with_invalid_token() ->
    ...
    Result = erlmcp_tasks:update_progress(undefined, TaskId, #{
