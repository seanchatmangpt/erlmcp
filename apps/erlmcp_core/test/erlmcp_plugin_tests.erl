...
get_exports(formatter) -> "format/2, supports_format/0";
get_exports(validator) -> "validate/2, get_schema/0";
get_exports(exporter) -> "export/2, get_config_schema/0";
get_exports(command) -> "execute/2, help/0";
get_exports(_) -> "".
