...
session_manager_test_() ->
    {foreach,
     ...
     [
         ...
         fun test_update_preserves_last_accessed/1,
         ...
         fun test_touch_updates_last_accessed/1,
         ...
         fun test_cleanup_expired_none/1,
         fun test_cleanup_expired_multiple/1,
         fun test_infinite_timeout_never_expires/1,
         ...
         fun test_session_id_cryptographically_random/1,
         ...
         fun test_last_accessed_initial_value/1,
         fun test_last_accessed_not_updated_on_list/1,
         ...
         fun test_cleanup_scheduled_correctly/1,
         fun test_cleanup_reschedules_after_execution/1,

         %% Replication Hook Tests (3 tests)
         fun test_session_replication_hooks/1,
         fun test_replicator_not_running/1,
         fun test_replication_events_dont_crash/1,
         ...
         fun test_ets_table_public/1,
         fun test_ets_table_ordered_set/1,
         fun test_ets_table_read_concurrency/1,

         %% Process Lifecycle Tests (4 tests)
         fun test_terminate_cleans_up/1,
         fun test_terminate_cancels_timer/1,
         fun test_process_flag_trap_exit/1,
...
test_many_consecutive_operations(_Pid) ->
    fun() ->
        ...
        lists:foreach(fun(N) ->
            {ok, _Id} = erlmcp_session_manager:create_session(#{index => N})
...
property_session_roundtrip(_Pid) ->
    fun() ->
        ...
        end, lists:zip(SessionIds, RandomMetadatas)),
