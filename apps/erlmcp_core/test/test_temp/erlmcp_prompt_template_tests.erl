...
prompt_template_test_() ->
    {foreach,
     fun setup/0,
     fun cleanup/1,
     [fun test_simple_variable_rendering/1, fun test_multiple_variables/1,
      fun test_missing_variable_handling/1, fun test_numeric_value_rendering/1,
      fun test_boolean_value_rendering/1, fun test_section_rendering_truthy/1,
      fun test_section_rendering_falsy/1, fun test_section_rendering_list/1,
      fun test_inverted_section_truthy/1, fun test_inverted_section_falsy/1,
      fun test_inverted_section_empty_list/1, fun test_template_validation_valid/1,
      fun test_template_validation_invalid_syntax/1, fun test_template_validation_too_large/1,
      fun test_has_template_syntax_true/1, fun test_has_template_syntax_false/1,
      fun test_render_safe_valid/1, fun test_render_safe_invalid/1,
      fun test_security_invalid_variable_name/1, fun test_security_variable_name_too_long/1,
      fun test_security_variable_value_too_large/1, fun test_security_nesting_too_deep/1,
      fun test_security_output_too_large/1, fun test_whitespace_handling/1,
      fun test_empty_template/1, fun test_no_variables_template/1,
...
test_template_validation_invalid_syntax(_Pid) ->
    ?_test(begin
               ...
               ?assertMatch({error, {invalid_template_syntax, _}},
                            erlmcp_prompt_template:validate(Template))
           end).
...
test_security_nesting_too_deep(_Pid) ->
    ?_test(begin
               ...
               ?assertMatch({error, {nesting_too_deep, _, _}},
                            erlmcp_prompt_template:validate(Template))
           end).
