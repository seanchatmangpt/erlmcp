...
test_refusal_1001_queue_cap_exceeded() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_QUEUE_CAP_EXCEEDED),
...
test_refusal_1002_queue_byte_cap_exceeded() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_QUEUE_BYTE_CAP_EXCEEDED),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1003_tenant_cap_exceeded() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_QUEUE_TENANT_CAP_EXCEEDED),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1004_buffer_overflow() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_BUFFER_OVERFLOW),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1005_backpressure_active() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_BACKPRESSURE_ACTIVE),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1012_auth_expired() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_AUTH_EXPIRED),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1013_invalid_credentials() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_AUTH_INVALID_CREDENTIALS),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1014_authz_forbidden() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_AUTHZ_FORBIDDEN),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1015_auth_missing() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_AUTH_MISSING),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1016_session_invalid() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_SESSION_INVALID),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1021_invalid_params() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_INVALID_PARAMS),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1022_invalid_json_schema() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_INVALID_JSON_SCHEMA),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1024_invalid_content_type() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_INVALID_CONTENT_TYPE),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1025_invalid_header() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_INVALID_HEADER),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1026_invalid_session_id() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_INVALID_SESSION_ID),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1027_invalid_protocol_version() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_INVALID_PROTOCOL_VERSION),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1028_missing_required_field() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_MISSING_REQUIRED_FIELD),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1029_field_type_mismatch() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_FIELD_TYPE_MISMATCH),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1036_path_traversal_detected() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_PATH_TRAVERSAL_DETECTED),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1037_path_invalid() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_PATH_INVALID),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1038_symlink_traversal_detected() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_SYMLINK_TRAVERSAL_DETECTED),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1039_uri_out_of_bounds() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_URI_OUT_OF_BOUNDS),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1040_canonical_path_violation() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_CANONICAL_PATH_VIOLATION),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1046_resource_not_found() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_RESOURCE_NOT_FOUND),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1047_resource_duplicate() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_RESOURCE_DUPLICATE),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1048_tool_not_found() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_TOOL_NOT_FOUND),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1049_tool_duplicate() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_TOOL_DUPLICATE),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1050_prompt_not_found() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_PROMPT_NOT_FOUND),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1051_prompt_duplicate() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_PROMPT_DUPLICATE),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
...
test_refusal_1052_entity_duplicate() ->
    {ok, Code, Status, Message, Hint, Severity} =
        erlmcp_refusal:get_metadata(?REFUSAL_ENTITY_DUPLICATE),
    verify_metadata_format({Code, Status, Message, Hint, Severity}),
