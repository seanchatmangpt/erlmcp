...
model_provider_test_() ->
    {setup,
     ...
     fun(_) ->
        [fun get_model_provider/0, fun set_model_provider/0, fun provider_function_export_check/0]
     end}.
...
provider_switching_test_() ->
    {setup,
     fun setup_sampling_server/0,
     fun cleanup_sampling_server/1,
     fun(_) -> [fun switch_between_providers/0, fun provider_persistence_across_requests/0] end}.
...
provider_functionality_test_() ->
    {setup,
     fun setup_sampling_server/0,
     fun cleanup_sampling_server/1,
     fun(_) -> [fun provider_responds_to_requests/0, fun provider_handles_errors_gracefully/0] end}.
...
integration_test_() ->
    {setup,
     fun setup_sampling_server/0,
     fun cleanup_sampling_server/1,
     fun(_) -> [fun full_sampling_workflow/0, fun provider_with_parameters/0] end}.
