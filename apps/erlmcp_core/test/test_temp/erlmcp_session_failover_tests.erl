...
setup() ->
    ...
    of
        {atomic, ok} ->
            ok;
        {atomic, {already_exists, erlmcp_session}} ->
            ok;
        {aborted, {already_exists, erlmcp_session}} ->
            ok
    end,
    ...
    Record =
        #erlmcp_session{session_id = SessionId,
...
failover_test_() ->
    {foreach,
     ...
     [%% Lifecycle Tests (6 tests)
      ...
      fun test_start_link_with_nodes/1, fun test_start_link_connects_to_cluster/1,
      fun test_init_monitors_nodes/1, fun test_terminate_unmonitors_nodes/1,
      fun test_trap_exit_enabled/1,
      %% Backup Management Tests (7 tests)
      fun test_add_backup_to_session/1,
      fun test_add_multiple_backups/1, fun test_add_backup_invalid_node/1,
      fun test_add_backup_to_self/1, fun test_add_backup_down_node/1, fun test_remove_backup/1,
      fun test_remove_nonexistent_backup/1,
      %% Failover Tests (8 tests)
      fun test_failover_promotes_backup/1,
      fun test_failover_primary_still_alive/1, fun test_failover_already_primary/1,
      fun test_failover_session_not_found/1, fun test_failover_no_backups/1,
      fun test_failover_with_backup/1, fun test_manual_failover/1,
      fun test_failover_logs_promotion/1,
      %% Query Tests (5 tests)
      fun test_get_backup_nodes/1,
      fun test_get_backup_nodes_session_not_found/1, fun test_get_primary_node/1,
      fun test_get_primary_node_session_not_found/1, fun test_is_backup/1,
      %% Node Monitoring Tests (6 tests)
      fun test_nodeup_updates_status/1,
      fun test_nodedown_triggers_failover/1, fun test_nodedown_updates_status/1,
      fun test_nodedown_handles_multiple_sessions/1, fun test_nodedown_no_backup_marks_down/1,
      fun test_nodedown_backup_failure/1,
      %% Replication Tests (4 tests)
      fun test_force_sync_success/1,
      fun test_force_sync_session_not_found/1, fun test_replicate_session_to_backup/1,
      fun test_replicate_session_to_all_backups/1,
      %% Split-Brain Prevention Tests (3 tests)
      fun test_failover_checks_primary_status/1,
      fun test_failover_refuses_when_primary_up/1, fun test_backup_promotion_on_primary_down/1,
      %% Error Handling Tests (5 tests)
      fun test_handle_call_unknown_request/1,
      fun test_handle_info_exit_signal/1, fun test_handle_info_unknown_message/1,
      fun test_add_backup_session_creation/1, fun test_remove_backup_idempotent/1,
      %% State Management Tests (4 tests)
      fun test_state_initialization/1,
      fun test_state_tracks_sessions/1, fun test_state_tracks_node_status/1,
