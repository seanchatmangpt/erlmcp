    ...
    [?_test(begin
                ...
                ok =
                    erlmcp_cache:put(<<"key1">>,
                                     ...
                                     #{tags => [<<"user:123">>]}),
                ok =
                    erlmcp_cache:put(<<"key2">>,
                                     <<"value2">>,
                                     {ttl, 300},
                                     #{tags => [<<"user:123">>]}),
                ok =
                    erlmcp_cache:put(<<"key3">>,
                                     <<"value3">>,
                                     {ttl, 300},
                                     #{tags => [<<"user:456">>]}),
...
test_dependency_tracking(_Pid) ->
    [?_test(begin
                ...
                %% Put dependent keys
                ok =
                    erlmcp_cache:put(<<"dep1">>,
                                     <<"value_dep1">>,
                                     {ttl, 300},
                                     #{dependencies => [<<"primary">>]}),
                ok =
                    erlmcp_cache:put(<<"dep2">>,
                                     <<"value_dep2">>,
                                     {ttl, 300},
                                     #{dependencies => [<<"primary">>]}),
                ...
                Pids =
                    lists:map(fun(N) ->
                                 spawn(fun() ->
                                          lists:foreach(fun(M) ->
                                                           Key =
                                                               iolist_to_binary(io_lib:format("key_~p",
                                                                                              [M
                                                                                               rem 10])),
                                                           Value =
                                                               iolist_to_binary(io_lib:format("value_~p_~p",
                                                                                              [N,
                                                                                               M])),
                                                           ok = erlmcp_cache:put(Key, Value),
