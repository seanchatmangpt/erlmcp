...
test_validate_required_present() ->
    ...
    Result =
        erlmcp_schema_registry:validate(<<"required_schema">>,
                                        {1, 0, 0},
                                        #{<<"name">> => <<"test">>}),
...
test_validate_optional_fields() ->
    ...
    Result =
        erlmcp_schema_registry:validate(<<"optional_schema">>,
                                        {1, 0, 0},
                                        #{<<"name">> => <<"test">>}),
...
test_validate_extra_fields() ->
    ...
    Result =
        erlmcp_schema_registry:validate(<<"extra_schema">>,
                                        {1, 0, 0},
...
test_validate_no_extra_fields() ->
    ...
    Result =
        erlmcp_schema_registry:validate(<<"strict_schema">>,
                                        {1, 0, 0},
                                        #{<<"name">> => <<"test">>, <<"extra">> => <<"field">>}),
...
test_validate_string_maxlength() ->
    ...
    InvalidResult =
        erlmcp_schema_registry:validate(<<"maxlength_schema">>, {1, 0, 0}, <<"abcdef">>),
