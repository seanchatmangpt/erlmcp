...
initialized_notification_test_() ->
    {setup,
     ...
     fun cleanup/1,
     fun(_) ->
        [{"Initialized notification is sent after initialize",
          fun test_initialized_notification_sent/0},
...
test_initialized_notification_format() ->
    ...
    ?assertMatch(#json_rpc_notification{method = <<"notifications/initialized">>, params = #{}},
                 Notification).
