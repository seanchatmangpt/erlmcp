...
test_add_prompt_with_args() ->
    ...
    Handler =
        fun(A) ->
           [#{role => <<"system">>,
              content =>
                  #{type => <<"text">>, text => <<"Topic: ", (maps:get(<<"topic">>, A))/binary>>}}]
        end,
...
test_delete_prompt() ->
    ...
    Handler =
        fun(_Args) -> [#{role => <<"user">>, content => #{type => <<"text">>, text => <<"ok">>}}]
        end,
...
test_arg_types() ->
    ...
    Args =
        [#mcp_prompt_argument{name = <<"string_arg">>,
                              description = <<"String argument">>,
                              required = true},
         #mcp_prompt_argument{name = <<"number_arg">>,
                              description = <<"Number argument">>,
                              required = false},
         #mcp_prompt_argument{name = <<"bool_arg">>,
...
test_optional_args() ->
    ...
    Args =
        [#mcp_prompt_argument{name = <<"required_arg">>,
                              description = <<"Required argument">>,
                              required = true},
         #mcp_prompt_argument{name = <<"optional_arg">>,
                              description = <<"Optional argument">>,
                              required = false},
         #mcp_prompt_argument{name = <<"another_optional">>,
    ...
    ?assertEqual(ok,
                 erlmcp_server:add_prompt_with_args(Server, <<"optional_test">>, Handler, Args)),
...
test_prompt_schema() ->
    ...
    Schema1 = #{type => <<"object">>},
    Args1 =
        [#mcp_prompt_argument{name = <<"arg1">>,
                              description = <<"Test">>,
                              required = true}],
    Handler1 =
        fun(_A) -> [#{role => <<"user">>, content => #{type => <<"text">>, text => <<"ok1">>}}] end,
    ?assertEqual(ok,
                 erlmcp_server:add_prompt_with_args_and_schema(Server,
                                                               <<"schema1">>,
                                                               Handler1,
    ...
    Args2 =
        [#mcp_prompt_argument{name = <<"arg2">>,
                              description = <<"Test">>,
                              required = true}],
    Handler2 =
        fun(_A) -> [#{role => <<"user">>, content => #{type => <<"text">>, text => <<"ok2">>}}] end,
    ?assertEqual(ok,
                 erlmcp_server:add_prompt_with_args_and_schema(Server,
                                                               <<"schema2">>,
                                                               Handler2,
    ...
    Args3 =
        [#mcp_prompt_argument{name = <<"arg3">>,
                              description = <<"Test">>,
                              required = true}],
    Handler3 =
        fun(_A) -> [#{role => <<"user">>, content => #{type => <<"text">>, text => <<"ok3">>}}] end,
    ?assertEqual(ok,
                 erlmcp_server:add_prompt_with_args_and_schema(Server,
                                                               <<"schema3">>,
                                                               Handler3,
...
test_resource_content() ->
    ...
    Handler =
        fun(_Args) ->
           [#{role => <<"user">>,
              content => #{type => <<"resource">>, uri => <<"file:///path/to/resource">>}}]
        end,
...
start_server() ->
    ...
    Capabilities = #mcp_server_capabilities{prompts = #mcp_capability{enabled = true}},
