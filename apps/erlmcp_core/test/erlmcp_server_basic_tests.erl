...
test_concurrent_resources() ->
    Server = start_server_with_caps(<<"concurrent_resources">>, #mcp_server_capabilities{
        resources = #mcp_capability{enabled = true}
    }),
...
test_concurrent_tools() ->
    Server = start_server_with_caps(<<"concurrent_tools">>, #mcp_server_capabilities{
        tools = #mcp_capability{enabled = true}
    }),
...
test_concurrent_prompts() ->
    Server = start_server_with_caps(<<"concurrent_prompts">>, #mcp_server_capabilities{
        prompts = #mcp_capability{enabled = true}
    }),
...
test_concurrent_deletions() ->
    Server = start_server_with_caps(<<"concurrent_deletions">>, #mcp_server_capabilities{
        resources = #mcp_capability{enabled = true},
        tools = #mcp_capability{enabled = true}
    }),
