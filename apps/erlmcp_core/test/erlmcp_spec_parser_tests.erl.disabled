...
list_error_codes_test_() ->
    {setup,
     ...
     [
      ...
      {"Get all error codes contains -32700", fun test_get_all_error_codes_contains_parse_error/0}
     ]}.
...
required_params_test_() ->
    {setup,
     ...
     [
      ...
      {"Get required params for unknown method returns empty", fun test_get_required_params_unknown/0}
     ]}.
...
state_transitions_test_() ->
    {setup,
     ...
     [
      ...
      {"Validate pending to processing transition", fun test_state_transition_pending_to_processing/0},
      {"Validate processing to completed transition", fun test_state_transition_processing_to_completed/0},
      {"Validate processing to failed transition", fun test_state_transition_processing_to_failed/0},
      {"Validate pending to cancelled transition", fun test_state_transition_pending_to_cancelled/0},
