...
validate_concurrent_connections_fail_rate_test() ->
    ...
    Result =
        erlmcp_performance_validator:validate_concurrent_connections(?TEST_CONCURRENT_FAIL_RATE),
...
validate_concurrent_connections_fail_count_test() ->
    ...
    Result =
        erlmcp_performance_validator:validate_concurrent_connections(?TEST_CONCURRENT_FAIL_COUNT),
...
format_report_test() ->
    ...
    ConcurrentValidated =
        erlmcp_performance_validator:validate_concurrent_connections(?TEST_CONCURRENT_PASS),
