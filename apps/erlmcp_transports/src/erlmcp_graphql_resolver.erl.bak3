...
resolve_tools(#{server_pid := ServerPid}, _Args) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error resolving tools: ~p:~p~n~p", [Class, Error, Stack]),
...
resolve_tool(#{server_pid := ServerPid}, #{<<"name">> := Name}) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error resolving tool ~p: ~p:~p~n~p", [Name, Class, Error, Stack]),
...
resolve_resources(#{server_pid := ServerPid}, _Args) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error resolving resources: ~p:~p~n~p", [Class, Error, Stack]),
...
resolve_resource(#{server_pid := ServerPid}, #{<<"uri">> := Uri}) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error resolving resource ~p: ~p:~p~n~p", [Uri, Class, Error, Stack]),
...
resolve_resource_read(#{server_pid := ServerPid, transport_id := TransportId}, #{<<"uri">> := Uri}) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error reading resource ~p: ~p:~p~n~p", [Uri, Class, Error, Stack]),
...
resolve_prompts(#{server_pid := ServerPid}, _Args) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error resolving prompts: ~p:~p~n~p", [Class, Error, Stack]),
...
resolve_prompt(#{server_pid := ServerPid}, #{<<"name">> := Name}) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error resolving prompt ~p: ~p:~p~n~p", [Name, Class, Error, Stack]),
...
resolve_prompt_get(#{server_pid := ServerPid, transport_id := TransportId}, Args) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error getting prompt ~p: ~p:~p~n~p", [Name, Class, Error, Stack]),
            {error, <<"Failed to get prompt">>}
    end.
...
resolve_call_tool(#{server_pid := ServerPid, transport_id := TransportId}, Args) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error calling tool ~p: ~p:~p~n~p", [Name, Class, Error, Stack]),
...
subscribe_resource_updated(#{server_pid := ServerPid}, Args) ->
    ...
    try
        ...
        Class:Error:Stack ->
            ?LOG_ERROR("Error subscribing to resource: ~p:~p~n~p", [Class, Error, Stack]),
